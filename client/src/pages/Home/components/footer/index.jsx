...
function Footer() {
  return (
    <div><footer className="text-center bg-black text-white mt-28">
        ...
        <form action="">
          <div className="grid md:grid-cols-3 gird-cols-1 gap-4 flex justify-center items-center">
            <div className="md:ml-auto md:mb-6">
              <p className="">
                <strong>Connecter pour en savoir plus</strong>
              </p>
            </div>
    ...
    <div className="text-center p-4" >
      © 2022 Copyright:
      <a className="text-white" href="https://tailwind-elements.com/">Géni Elements</a>
    </div>
  </footer></div>
  )
}
